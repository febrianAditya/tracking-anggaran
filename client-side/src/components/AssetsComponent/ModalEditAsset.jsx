...
export default function ModalEditAsset({ dataAsset }) {
    const [data, setData] = useState({})


    useEffect(() => {
        // console.log(dataAsset,"==> wk");
    ...
    return(
        <>
            <div className="modal fade" id="editAsset" tabIndex="-1" aria-hidden="true">
                    ...
                    <div className="modal-content p-0">
                        <div className="modal-body">
                            ...
                            <div className="text-center">
                                <h4 className="mb-3">Edit Asset</h4>
                            </div>
